...
process.MessageLogger.categories.append("ExcludedModules")  
...
process.MessageLogger.cout = cms.untracked.PSet(
    ...
    ExcludedModules = cms.untracked.PSet( limit = cms.untracked.int32(-1)),
...
process.GlobalTag.toGet = cms.VPSet(
    cms.PSet(record = cms.string("SiStripApvGain3Rcd"),
             ...
             connect = cms.string("sqlite_file:promptCalibConditions81684.db")
             )
    )
...
## Worker module
##
process.SiStripPayloadCopyAndExclude = cms.EDAnalyzer('SiStripPayloadCopyAndExclude',
                                                      ### FED 387
...
process.p = cms.Path(process.SiStripPayloadCopyAndExclude)

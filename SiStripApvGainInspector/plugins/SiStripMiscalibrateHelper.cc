...
/*--------------------------------------------------------------------*/
std::pair<float,float> SiStripMiscalibrate::getTruncatedRange(const TrackerMap* theMap,double nsigmas){
/*--------------------------------------------------------------------*/  
  ...
  auto range = SiStripPI::getTheRange(info_per_detid,nsigmas);
  return range;

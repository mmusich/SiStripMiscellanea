...
#include "../interface/SiStripMiscalibrateHelper.h"
...
SiStripApvGainInspector::endJob()
{
  ...
  auto range = SiStripMiscalibrate::getTruncatedRange(ratio_map.get(),2);
  ...
  range = SiStripMiscalibrate::getTruncatedRange(old_payload_map.get(),2);
  ...
  range = SiStripMiscalibrate::getTruncatedRange(new_payload_map.get(),2);

// -*- C++ -*-
//
// Package:    SiStripMiscellanea/SiStripPayloadCopyAndExclude
// Class:      SiStripPayloadCopyAndExclude
//
/**\class SiStripPayloadCopyAndExclude SiStripPayloadCopyAndExclude.cc SiStripMiscellanea/SiStripPayloadCopyAndExclude/plugins/SiStripPayloadCopyAndExclude.cc
...
class SiStripPayloadCopyAndExclude : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit SiStripPayloadCopyAndExclude(const edm::ParameterSet&);
      ~SiStripPayloadCopyAndExclude();
...
//
SiStripPayloadCopyAndExclude::SiStripPayloadCopyAndExclude(const edm::ParameterSet& iConfig):
...
SiStripPayloadCopyAndExclude::~SiStripPayloadCopyAndExclude()
{
...
void
SiStripPayloadCopyAndExclude::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;

  // gain to be validated
  edm::ESHandle<SiStripApvGain> gNew; iSetup.get<SiStripApvGain3Rcd>().get(gNew);
  edm::ESHandle<SiStripGain> gOld; iSetup.get<SiStripGainRcd>().get(gOld);
  ...
  for (const auto & d : detid) {
	...
	if(d == mod ) {
      ...
      if(m_reverseSelect) found =(!found);
...
SiStripPayloadCopyAndExclude::getNewObject(const std::map<std::pair<uint32_t,int>,float>& theMap) 
{
...
void
SiStripPayloadCopyAndExclude::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void
SiStripPayloadCopyAndExclude::endJob()
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
SiStripPayloadCopyAndExclude::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(SiStripPayloadCopyAndExclude);

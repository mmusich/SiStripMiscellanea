...
public:
  ...
  ~SiStripPayloadCopyAndExclude() override;
...
void SiStripPayloadCopyAndExclude::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;

  // gain to be validated
  edm::ESHandle<SiStripApvGain> gNew;
  iSetup.get<SiStripApvGain3Rcd>().get(gNew);
  edm::ESHandle<SiStripGain> gOld;
  iSetup.get<SiStripGainRcd>().get(gOld);
...
void SiStripPayloadCopyAndExclude::beginJob() {}

// ------------ method called once each job just after ending the event loop  ------------
void SiStripPayloadCopyAndExclude::endJob() {}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void SiStripPayloadCopyAndExclude::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {

#ifndef SISTRIPMISCELLANEA_SISTRIPAPVGAININSPECTOR_SISTRIPMISCALIBRATEHELPER
#define SISTRIPMISCELLANEA_SISTRIPAPVGAININSPECTOR_SISTRIPMISCALIBRATEHELPER
...
namespace SiStripMiscalibrate {
  ...
  std::pair<float,float> getTruncatedRange(const TrackerMap* theMap,double nsigmas);  

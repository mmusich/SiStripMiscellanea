...
//*************************************************************
{
  ...
  TString dets[22] = {"TIB_L1",     "TIB_L2",     "TIB_L3",     "TIB_L4",     "TOB_L1",     "TOB_L2",
                      "TOB_L3",     "TOB_L4",     "TOB_L5",     "TOB_L6",     "TID_Disk 1", "TID_Disk 2",
                      "TID_Disk 3", "TEC_Disk 1", "TEC_Disk 2", "TEC_Disk 3", "TEC_Disk 4", "TEC_Disk 5",
                      "TEC_Disk 6", "TEC_Disk 7", "TEC_Disk 8", "TEC_Disk 9"};
  TH1F *histosToFit[22];
  ...
  for (Int_t i = 0; i < 22; i++) {
    ...
    histosToFit[i] =
        (TH1F *)f->Get(Form("SiStripGainsValidator/ClusterCharge/clusterChargeOverPathNewG2_%s", dets[i].Data()));
